#
#  Base class for Woodhouse Runners.
#
#  Runners must subclass this and implement the method 
#
#     Woodhouse::Remote::Runners::Base#run(clazz, method, options = {})
#
...
#
#      Woodhouse.find(clazz, method).dispatch_to_worker_method(method, options)
#
#  This ensures for consistent logging and handling of propagated exceptions. You can
#  also call the convenience method 
#       
#      Woodhouse::Remote::Runners::Base#dispatch!(clazz, method, options)
#
  ...
  module Remote
    module Runners
      class Base
        ...
        # default logger defined in Woodhouse::Base.logger
        def logger
          Woodhouse::Base.logger
        end
